...
import random
import string
from ncm.config import COOKIE

# Encrypt key
modulus = ''
nonce = '0CoJUm6Qyw8W8jud'
pub_key = '010001'
csrf = ['' if COOKIE.find('csrf')==-1 else COOKIE[COOKIE.find('csrf=')+5:COOKIE.find('csrf=')+5+32]][0]
...
def get_lyirc_url(song_id):
    return 'http://music.163.com/api/song/lyric?id={}&lv=-1&kv=-1&tv=-1'.format(song_id)